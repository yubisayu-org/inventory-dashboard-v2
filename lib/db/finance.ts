...
export async function executeRefund(
  ...
  await sql.begin(async (tx) => {
    ...
    // Locked, and re-read inside the transaction: the amount below is computed
    // from live data, so a second execute racing this one must wait rather than
    // read the same balance and pay it twice.
