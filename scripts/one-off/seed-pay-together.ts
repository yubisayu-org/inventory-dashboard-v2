...
async function main() {
  ...
  // Marks write the item, the count and what each cost into the note as they
  // go, one line per item where several merged into the same refund. That is
  // what a group opens to show, so the seed has to carry it.
